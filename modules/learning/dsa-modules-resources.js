const dsaModuleResources = {
  ...
  "language-syntax": {
    ...
    additionalResources: [
      { title: "Java Syntax – W3Schools", url: "https://www.w3schools.com/java/java_syntax.asp" },
      { title: "C++ Language Tutorial – cppreference", url: "https://en.cppreference.com/w/cpp/language" }
    ],
    placementRelevance: {
      patterns: [
        "Choosing idiomatic constructs for the interview language",
        "Proper use of built-in data types and type coercion",
        "String manipulation without library shortcuts",
        "Clean variable naming and code readability under pressure"
      ],
  ...
  "control-structures": {
    ...
    placementRelevance: {
      patterns: [
        "Nested loop optimization to reduce O(n²) to O(n)",
        "Early termination with break/return for pruning",
        "Loop invariant reasoning for correctness proofs",
        "Two-pointer and sliding window via loop control"
      ],
  ...
  "functions": {
    ...
    additionalResources: [
      ...
      { title: "Python Functions – Real Python", url: "https://realpython.com/defining-your-own-python-function/" }
    ],
    placementRelevance: {
      patterns: [
        "Helper function decomposition for cleaner interview code",
        "Pass-by-value vs pass-by-reference bugs in Java/C++",
        "Higher-order functions and callbacks (map/filter/reduce)",
  ...
  "oop-basics": {
    ...
    additionalResources: [
      { title: "SOLID Principles – DigitalOcean", url: "https://www.digitalocean.com/community/conceptual-articles/s-o-l-i-d-the-first-five-principles-of-object-oriented-design" }
    ],
    placementRelevance: {
      patterns: [
        "Encapsulation via private fields + getter/setter",
        "Polymorphism for extensible design (Strategy pattern)",
        "Abstract classes vs interfaces trade-offs",
        "Inheritance hierarchies in system design questions"
      ],
  ...
  "recursion-intro": {
    ...
    additionalResources: [
      ...
      { title: "Recursion Problems – LeetCode Explore", url: "https://leetcode.com/explore/learn/card/recursion-i/" }
    ],
    placementRelevance: {
      patterns: [
        "Identifying base case + recursive case",
        "Tail recursion and stack overflow prevention",
        "Tree-shaped recursion (Fibonacci, permutations)",
  ...
  "big-o": {
    ...
    creator: "HackerRank",
    primaryLink: { title: "Big-O Cheat Sheet", url: "https://www.bigocheatsheet.com/" },
    additionalResources: [
      { title: "Time Complexity – GeeksforGeeks", url: "https://www.geeksforgeeks.org/understanding-time-complexity-simple-examples/" },
      { title: "Complexity Analysis – CP-Algorithms", url: "https://cp-algorithms.com/algebra/complexity.html" }
    ],
    placementRelevance: {
      patterns: [
        "Amortized analysis for dynamic arrays",
        "Best/average/worst-case distinction",
        "Recognizing log n from halving patterns",
        "Space-time trade-off articulation"
      ],
  ...
  "asymptotic-notation": {
    ...
    placementRelevance: {
      patterns: [
        "Theta vs Big-O vs Omega distinctions",
        "Tight bound derivation for sorting algorithms",
        "Recurrence relation solving (Master Theorem)",
        "Proving lower bounds for comparison-based sorts"
      ],
  ...
  "arrays": {
    ...
    additionalResources: [
      ...
      { title: "Arrays – Visualgo", url: "https://visualgo.net/en/array" }
    ],
    placementRelevance: {
      patterns: [
        "Two-pointer technique (sorted arrays, palindromes)",
        "Sliding window (max subarray, minimum window substring)",
        "Prefix sum for range query O(1)",
  ...
  "strings": {
    ...
    additionalResources: [
      { title: "KMP Algorithm – CP-Algorithms", url: "https://cp-algorithms.com/string/prefix-function.html" },
      { title: "String Hashing – CP-Algorithms", url: "https://cp-algorithms.com/string/string-hashing.html" }
    ],
    placementRelevance: {
      patterns: [
        "Sliding window for substring problems",
        "Character frequency map (anagram detection)",
  ...
  "searching": {
    ...
    additionalResources: [
      ...
      { title: "Search Algorithms – GeeksforGeeks", url: "https://www.geeksforgeeks.org/searching-algorithms/" }
    ],
    placementRelevance: {
      patterns: [
        "Binary search on answer space (not just sorted array)",
        "Finding leftmost / rightmost boundary (lo=mid+1 variants)",
  ...
  "stack-queue": {
    ...
    additionalResources: [
      ...
      { title: "Monotonic Stack – GeeksforGeeks", url: "https://www.geeksforgeeks.org/introduction-to-monotonic-stack-data-structure-and-algorithm-tutorials/" }
    ],
    placementRelevance: {
      patterns: [
  ...
  "linked-list": {
    ...
    additionalResources: [
      ...
      { title: "Floyd's Cycle Detection – GeeksforGeeks", url: "https://www.geeksforgeeks.org/floyds-cycle-finding-algorithm/" }
    ],
    placementRelevance: {
      patterns: [
        "Fast & slow pointer (cycle detection, middle node)",
        "Dummy node technique for cleaner edge cases",
        "In-place reversal (reverse k-group)",
  ...
  "hash-tables": {
    ...
    additionalResources: [
      ...
      { title: "Hash Functions – CP-Algorithms", url: "https://cp-algorithms.com/string/string-hashing.html" }
    ],
    placementRelevance: {
      patterns: [
        "Complement lookup (Two Sum pattern)",
        "Frequency counting for anagrams/duplicates",
  ...
  "heaps": {
    ...
    additionalResources: [
      ...
      { title: "Heap – Visualgo", url: "https://visualgo.net/en/heap" }
    ],
    placementRelevance: {
      patterns: [
        ...
        "Heap-based Dijkstra's shortest path",
        "Heap sort in-place"
      ],
  ...
  "matrices": {
    ...
    placementRelevance: {
      patterns: [
        "BFS/DFS on grid (number of islands)",
        "In-place rotation (90-degree matrix rotation)",
        "Spiral order traversal",
        "Dynamic programming on 2D grid",
  ...
  "trees-bst": {
    ...
    additionalResources: [
      ...
      { title: "Trees – GeeksforGeeks", url: "https://www.geeksforgeeks.org/binary-tree-data-structure/" }
    ],
    placementRelevance: {
      patterns: [
        "Inorder traversal gives sorted output in BST",
        "LCA (Lowest Common Ancestor) in BST vs general tree",
        "BST validation using min/max bounds",
  ...
  "tree-traversal": {
    ...
    additionalResources: [
      ...
      { title: "Morris Traversal – GeeksforGeeks", url: "https://www.geeksforgeeks.org/inorder-tree-traversal-without-recursion-and-without-stack/" }
    ],
    placementRelevance: {
      patterns: [
        ...
        "Vertical order / diagonal traversal",
  ...
  "avl-trees": {
    ...
    additionalResources: [
      { title: "AVL Tree – Visualgo", url: "https://visualgo.net/en/bst" },
      { title: "Red-Black vs AVL – CP-Algorithms", url: "https://cp-algorithms.com/data_structures/treap.html" }
    ],
    placementRelevance: {
      patterns: [
        "Balance factor calculation and rotation types",
        "Left-Left, Left-Right, Right-Right, Right-Left rotations",
        "Height-balanced BST invariant proof",
        "Comparison with Red-Black Tree trade-offs",
        "Self-balancing for sorted data insertions"
      ],
  ...
  "tries": {
    ...
    creator: "NeetCode",
    primaryLink: { title: "Trie – LeetCode Explore Card", url: "https://leetcode.com/explore/learn/card/trie/" },
    additionalResources: [
      { title: "Trie – GeeksforGeeks", url: "https://www.geeksforgeeks.org/trie-insert-and-search/" },
      { title: "Trie – Visualgo", url: "https://visualgo.net/en/suffixtree" }
    ],
    placementRelevance: {
      patterns: [
        ...
        "Replace words with root using Trie"
      ],
  ...
  "graphs": {
    ...
    additionalResources: [
      ...
      { title: "Graph Algorithms – GeeksforGeeks", url: "https://www.geeksforgeeks.org/graph-data-structure-and-algorithms/" }
    ],
    placementRelevance: {
      patterns: [
        "BFS for shortest path in unweighted graphs",
        "DFS for connected components, cycle detection",
        "Topological sort (Kahn's BFS + DFS approaches)",
  ...
  "dynamic-programming": {
    ...
    additionalResources: [
      ...
      { title: "DP Introduction – CP-Algorithms", url: "https://cp-algorithms.com/dynamic_programming/intro-to-dp.html" }
    ],
    placementRelevance: {
      patterns: [
        "Memoization (top-down) vs tabulation (bottom-up)",
        "1D/2D DP on strings (LCS, Edit Distance)",
        "Knapsack variants (0/1, unbounded, partition)",
        "DP on trees and intervals",
        "State compression with bitmask DP"
      ],
      ...
      targetCompanies: ["Google", "Amazon", "Goldman Sachs", "Directi"],
      interviewTip: "Define the dp state in one precise English sentence before writing any code: 'dp[i][j] = minimum cost to convert s[0..i] to t[0..j]' — if you can't state it clearly, you don't understand the problem yet."
    }
  },
  ...
  "greedy": {
    ...
    creator: "Abdul Bari",
    primaryLink: { title: "Greedy Algorithms – GeeksforGeeks", url: "https://www.geeksforgeeks.org/greedy-algorithms/" },
    additionalResources: [
      { title: "Greedy – CP-Algorithms", url: "https://cp-algorithms.com/greedy/index.html" }
    ],
    placementRelevance: {
      patterns: [
        "Activity selection / interval scheduling",
        "Huffman encoding for optimal prefix codes",
        "Jump Game reachability",
        "Minimum number of platforms/rooms",
        "Prove greedy choice property before coding"
      ],
  ...
  "recursion-backtracking": {
    ...
    additionalResources: [
      ...
      { title: "Backtracking – CP-Algorithms", url: "https://cp-algorithms.com/combinatorics/generating_combinations.html" }
    ],
    placementRelevance: {
      patterns: [
        "Permutations and combinations generation",
        "N-Queens and Sudoku solver",
        "Subsets and power set enumeration",
        "Pruning with constraints (early termination)",
  ...
  "bit-manipulation": {
    ...
    additionalResources: [
      ...
      { title: "Bitwise Operators – GeeksforGeeks", url: "https://www.geeksforgeeks.org/bitwise-operators-in-c-cpp/" }
    ],
    placementRelevance: {
      patterns: [
        "XOR for finding single/missing number",
        "Bitmask DP for subset enumeration",
        "Brian Kernighan's algorithm (count set bits)",
        "Power of 2 check: `n & (n-1) == 0`",
        "Bit shifting for fast multiplication/division"
      ],
  ...
  "divide-conquer": {
    ...
    additionalResources: [
      ...
      { title: "D&C – CP-Algorithms", url: "https://cp-algorithms.com/algebra/fft.html" }
    ],
    placementRelevance: {
      patterns: [
        "Merge sort for inversion count",
        "Quick select for Kth largest O(n) average",
        "Binary search as D&C on sorted space",
  ...
  "disjoint-set": {
    ...
    additionalResources: [
      ...
      { title: "DSU – LeetCode Explore", url: "https://leetcode.com/explore/learn/card/graph/618/disjoint-set/" }
    ],
    placementRelevance: {
      patterns: [
        "Union by rank + path compression for O(α(n))",
  ...
  "segment-tree": {
    ...
    additionalResources: [
      ...
      { title: "Segment Tree – Visualgo", url: "https://visualgo.net/en/segmenttree" }
    ],
    placementRelevance: {
      patterns: [
        ...
        "Merge sort tree for frequency in range"
      ],
  ...
  "fenwick-tree": {
    ...
    additionalResources: [
      ...
      { title: "Fenwick Tree – Visualgo", url: "https://visualgo.net/en/fenwicktree" }
    ],
    placementRelevance: {
      patterns: [
        "Prefix sum with point updates in O(log n)",
        "Count inversions using BIT",
        "Range sum queries on 2D BIT",
        "Order statistics (rank of elements)",
        "BIT vs Segment Tree trade-off explanation"
      ],
  ...
  "lru-cache": {
    ...
    creator: "NeetCode",
    primaryLink: { title: "LRU Cache – LeetCode Problem", url: "https://leetcode.com/problems/lru-cache/" },
    additionalResources: [
      { title: "LRU Cache Design – GeeksforGeeks", url: "https://www.geeksforgeeks.org/lru-cache-implementation/" },
  ...
  "bitwise-trie": {
    ...
    placementRelevance: {
      patterns: [
        "Maximum XOR of two numbers in O(32n)",
        "Maximum XOR with element from array",
        "IP routing via longest prefix match",
        "Binary number insertion bit by bit",
        "Combining bitmask DP with trie"
      ],
  ...
  "dijkstra-algo": {
    ...
    additionalResources: [
      ...
      { title: "Dijkstra – GeeksforGeeks", url: "https://www.geeksforgeeks.org/dijkstras-shortest-path-algorithm-greedy-algo-7/" }
    ],
    placementRelevance: {
      patterns: [
        "Priority queue-based implementation O((V+E) log V)",
        "Modified Dijkstra for K-stops constraint",
        "Bidirectional Dijkstra for performance",
        "Dijkstra on state-space graphs",
  ...
  "bellman-ford": {
    ...
    additionalResources: [
      ...
      { title: "Bellman-Ford – Visualgo", url: "https://visualgo.net/en/sssp" }
    ],
    placementRelevance: {
      patterns: [
        "V-1 edge relaxations for correctness",
        "Negative cycle detection on Vth iteration",
        "SPFA (queue-optimized Bellman-Ford)",
        "Arbitrage detection in currency exchange",
        "Difference constraints system solving"
      ],
  ...
  "floyd-warshall": {
    ...
    placementRelevance: {
      patterns: [
        ...
        "Negative cycle detection via diagonal",
        "Optimal routing table computation",
        "DP formulation: dp[i][j][k] → dp[i][j]"
      ],
  ...
  "kruskal-mst": {
    ...
    placementRelevance: {
      patterns: [
        "Sort edges + Union-Find cycle detection",
        "MST for network design problems",
        "Maximum spanning tree (negate weights)",
        "Minimum cost to connect all points",
        "Kruskal vs Prim for sparse vs dense graphs"
      ],
  ...
  "prim-mst": {
    ...
    placementRelevance: {
      patterns: [
        "Greedy vertex expansion with priority queue O((V+E) log V)",
        "Dense graph MST with adjacency matrix O(V²)",
        "Comparing Prim's vs Kruskal's trade-offs",
        "Minimum cost to connect all cities",
        "Online MST construction (dynamic edge addition)"
      ],
...
module.exports = dsaModuleResources;
